                        ...
                        case 1:
                        {
                            ...
                            do
                            {
                                ...
                                case 1:
                                {
                                    ...
                                    scanf("%d", &id);
                                    rewind(arq_eventos);
                                    ev = Evento_buscaSequencial_PorId(arq_eventos, id, log_b);
                                    if (!ev)
                                    {
                                ...
                                case 2:
                                {
                                    ...
                                    scanf("%d", &id);
                                    rewind(arq_users);
                                    us = User_buscaSequencial_PorId(arq_users, id, log_b);
                                    if (!us)
                                    {
                                        printf("Id de numero %d nao encontrado.", id);
                                        printf("Tente novamente");
                        ...
                        case 2:
                        {
                            ...
                            do
                            {
                                ...
                                case 1:
                                {
                                    ...
                                    rewind(arq_eventos);
                                    ev = Evento_buscaBinaria_PorId(arq_eventos, idB, 0, tamanho_arquivoEv(arq_eventos) - 1, log_b);
                                ...
                                case 2:
                                {
                                    ...
                                    us = User_buscaBinaria_PorID(arq_users, idB, 0, tamanho_arquivoUs(arq_users) - 1, log_b);
                                    if (!us)
                                    {
                                        printf("Id de numero %d não encontrado.", idB);
                                        printf("Tente novamente");
